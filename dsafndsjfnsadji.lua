...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/UbitaLaUva/ev/main/ui.lua"))()
local Esp = loadstring(game:HttpGet("https://raw.githubusercontent.com/UbitaLaUva/ev/main/evEsp.lua"))()
Esp.Enabled = false
Esp.Tracers = false
Esp.Boxes = false

local Window = Library:CreateWindow("Ubita Hub🍇", Vector2.new(500, 300), Enum.KeyCode.RightShift)
...
Credits:AddLabel("Developed By Ubita🍇")
Credits:AddLabel("YouTube: Ubita Exploit ")
