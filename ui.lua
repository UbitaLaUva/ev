...
library.theme = {
    ...
    backgroundcolor = Color3.fromRGB(72, 38, 90),
    tabstextcolor = Color3.fromRGB(240, 240, 240),
    bordercolor = Color3.fromRGB(255, 87, 51),
    accentcolor = Color3.fromRGB(255, 87, 51),
    accentcolor2 = Color3.fromRGB(16, 31, 78),
    outlinecolor = Color3.fromRGB(255, 87, 51),
    outlinecolor2 = Color3.fromRGB(0, 0, 0),
    sectorcolor = Color3.fromRGB(30, 30, 30),
    toptextcolor = Color3.fromRGB(255, 255, 255),
    topheight = 48,
    topcolor = Color3.fromRGB(47, 24, 59),
    topcolor2 = Color3.fromRGB(47, 24, 59),
